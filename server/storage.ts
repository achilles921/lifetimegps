import { 
  ...
  careerRoadmaps, type CareerRoadmap, type InsertCareerRoadmap,
  guestSessions, type GuestSession, type InsertGuestSession,
  shadowingOpportunities, type ShadowingOpportunity, type InsertShadowingOpportunity,
  shadowingApplications, type ShadowingApplication, type InsertShadowingApplication,
  parentGuardians, type ParentGuardian, type InsertParentGuardian,
  miniGamePerformance, type MiniGamePerformance, type InsertMiniGamePerformance
} from "@shared/schema";
import { db } from "./db";
