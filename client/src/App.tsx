  ...
  return (
    <>
      ...
      <Switch>
        ...
        {/* Redirect for removed mini-games (unprotected to prevent 404) */}
        <Route path="/mini-games/echo-match">
          <div className="container mx-auto px-4 py-8 text-center">
            <h2 className="text-2xl font-bold mb-4">Game Removed</h2>
            <p className="mb-6">This mini-game has been removed. Please try one of our other games.</p>
            <button 
              onClick={() => window.location.href = '/mini-games'} 
              className="bg-primary text-white px-6 py-2 rounded-md"
            >
              Return to Mini-Games Hub
            </button>
          </div>
        </Route>
        <Route path="/mini-games/reaction-run">
          <div className="container mx-auto px-4 py-8 text-center">
            <h2 className="text-2xl font-bold mb-4">Game Removed</h2>
            <p className="mb-6">This mini-game has been removed. Please try one of our other games.</p>
            <button 
        ...
        <Route path="/mini-games/anki-learn">
          <div className="container mx-auto px-4 py-8 text-center">
            <h2 className="text-2xl font-bold mb-4">Game Removed</h2>
            <p className="mb-6">This mini-game has been removed. Please try one of our other games.</p>
            <button 
        ...
        {/* Add a catch for galaxy-explorer since we renamed it */}
        <Route path="/mini-games/galaxy-explorer">
          <div className="container mx-auto px-4 py-8 text-center">
            <h2 className="text-2xl font-bold mb-4">Game Removed</h2>
            <p className="mb-6">This mini-game has been removed. Please try one of our other games.</p>
            <button 
        ...
        <Route>
          {(params) => {
            console.log("404 Route triggered for path:", window.location.pathname);
            return <NotFound />;
          }}
        </Route>
      </Switch>
